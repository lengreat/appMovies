...
class DetailsSlide extends StatelessWidget {
  const DetailsSlide({ Key? key }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final MoviePopular movie=ModalRoute.of(context)!.settings.arguments as MoviePopular;//as movie, no lo convierte en movie, sino q lo trata como tal
